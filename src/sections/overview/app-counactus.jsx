...
const ContactUs = () => {
    ...
    return (
        <>
            {/* title */}
            <div>
                <div className="space-y-2 justify-start sm:space-y-3 sm:self-start">
                    <div className="flex items-center justify-center sm:justify-start gap-x-2.5">
                        <span className="hidden sm:inline-block w-4 h-4 bg-purple-950 rounded-sm" />
                        <h2 className="font-danaBold text-2xl sm:text-2.5xl">تماس با ما</h2>
                    </div>
                </div>
                            ...
                            <div className="h-48 w-full relative object-cover rounded-s-lg bg-[#232563] md:h-full md:w-64">
                                <div className="grid grid-flow-row p-5 pt-3 z-40  ">
                                    ...
                                    <div className="py-2.5 text-white text-sm flex flex-row">
                                        ...
                                        <a href={`tel:${data.Telephone1}`}>{data.Telephone1}</a>{" "}
                                        <span className="px-1">_</span>
                                        <a href={`tel:${data.Telephone2}`}>{data.Telephone2}</a>
                                    </div>
                                    <div className="py-2.5 text-white text-sm flex flex-row ">
                                        <svg
                                            viewBox="0 0 24 24"
                                    ...
                                    <div className="py-2.5 text-white text-sm flex flex-row z-50">
                                        ...
                                        <a href={`${data.MapLink}`} target="_blank" rel="noreferrer">
                                            {data.Address}
                                        </a>
                                    </div>
                                </div>
                                <div className="absolute inset-x-0 bottom-0 to  sm:z-0 ">
                                    <div className=" bg-[#834C9E] h-36 opacity-95 rounded-tl-full w-36 relative">
                                        <div className=" bg-[#83A3E0] h-24 w-24  rounded-full absolute left-0 top-0 opacity-85" />
                                    </div>

                                    <div className=" absolute bottom-0 left-0 flex justify-items-center m-2">
                                        {data.tweeter ? (
                                            <a href={data.tweeter} target="_blank" rel="noreferrer">
                                                <svg
                                                    //   tweeter
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="1em"
                            ...
                            <div className="mx-auto mt-1  sm:mt-1">
                                ...
                                <div className="mt-10">
                                    <button
                                        ...
                                        type="submit"
                                        className="block w-full rounded-md bg-[#232563] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-900"
                                    >
                                        ارسال پیام
                                    </button>
                                    {showAlert1 && (
                                    ...
                                    <div>
                                        ...
                                        <div className=" pt-16 bottom-0">
                                            <button
                                                ...
                                                type="submit"
                                                className="block w-full rounded-md bg-[#83A3E0] px-3.5 py-2.5 text-center text-xs font-semibold text-white shadow-sm hover:bg-[#6d93d8] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-900"
                                            >
                                                به من خبر بده
                                            </button>
                                            {showAlert2 && (
